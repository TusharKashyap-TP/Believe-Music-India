      ...
      {init && (
        <Particles
          ...
          options={{
            background: {
              color: {
                // ✅ Default to site background instead of blue
                value: background || "#080808",
              },
            },
            fullScreen: {
              enable: false,
            ...
            particles: {
              ...
              color: {
                // ✅ Default particle color changed to gold
              ...
              links: {
                blink: false,
                color: { value: "#C9A84C" }, // ✅ Gold link color if links ever enabled
                consent: false,
                distance: 100,
                enable: false,
                frequency: 1,
